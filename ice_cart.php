  ...
  $connect = mysqli_connect('localhost','root','','icecream');
    ...
    //get all item detail
	...
	
        {
          ...
          echo '<script>window.location = "ice_cart.php"</script>';
		...
		<div class="menu-container">
           ...
           <div class="container" style="width:700px;">  
                ...
                <div class="col-md-4">  
                     ...
                     <form method="post" action="ice_cart.php?action=add&id=<?php echo $row["id"];?>">  
                ...
                <h3>Order Details <b style="color: red">Your Cart</b></h3>  
                ...
                <div class="table-responsive">  
                     ...
                     <table class="table table-bordered">  
                          ...
                          <tr> 
                               ...
                               <td><a href="ice_cart.php?action=delete&id=<?php  echo $value['item_id'];?>"><span class="btn btn-danger">Remove</span></a></td>  
